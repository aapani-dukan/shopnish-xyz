...
import { verifyToken, AuthenticatedRequest } from './verifyToken.ts'; // Import verifyToken and AuthenticatedRequest
import { userRoleEnum } from '../../shared/backend/schema.ts'; // Import userRoleEnum
