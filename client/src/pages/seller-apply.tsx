...
export default function SellerApplyPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="text-center mb-12">
          <div className="w-20 h-20 bg-amber-100 rounded-full flex items-center justify-center mx-auto mb-6">
            <Rocket className="text-amber-600 w-8 h-8" />
          </div>
          ...
          <p className="text-lg text-gray-600 mb-8">
            Start your selling journey with us. Complete your application to get
          ...
          {[
            {
              ...
              desc: "Competitive rates to maximize your profits",
              bg: "bg-green-100",
            },
            {
              icon: <Zap className="text-blue-600 w-6 h-6" />,
              title: "Fast Setup",
              desc: "Get your store up and running quickly",
              bg: "bg-blue-100",
            },
            {
              icon: <Headphones className="text-purple-600 w-6 h-6" />,
              title: "24/7 Support",
              desc: "Dedicated support team to help you succeed",
              bg: "bg-purple-100",
            },
            {
              icon: <Globe className="text-red-600 w-6 h-6" />,
              title: "Global Reach",
              desc: "Access customers from around the world",
              bg: "bg-red-100",
            },
      ...
      {/* ── Seller-registration modal (page-mode) ─────────── */}
      {showModal && <SellerRegistrationModal isPageMode={true} />}
    </div>
  );
}
