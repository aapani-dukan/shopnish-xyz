...
if (isDeliveryBoy) { 
    ...
    else { if (currentPath !== "/delivery-apply") {
        setLocation("/delivery-apply");
        return null; 
    } 
         }
} 
else { if (currentPath === "/delivery-dashboard") { 
    setLocation("/delivery-apply");
    return null; 
} 
     }
...
{/* Seller routes */}
  ...
  {/* Admin route - excluded from login logic */}
...
function App() { 
    return ( <QueryClientProvider
                 client={queryClient}> <TooltipProvider>
                     <AuthProvider>
                         <Toaster /> 
                         <AppRouter /> 
                     </AuthProvider> 
